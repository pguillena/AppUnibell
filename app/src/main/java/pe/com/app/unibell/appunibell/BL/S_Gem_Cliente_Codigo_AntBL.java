...
public class S_Gem_Cliente_Codigo_AntBL {
        ...
        try {
            ...
            if (jsonObjectRest.getInt("status")!=1) {
                ...
                for(int i=0;i<jsonObjectRest.getJSONArray("datos").length();i++) {
                    ...
                    s_gem_cliente_codigo_antBE.setID_CLIENTE(jsonObjectItem.getInt("ID_CLIENTE"));
                    s_gem_cliente_codigo_antBE.setCODIGO_ANTIGUO(jsonObjectItem.getString("CODIGO_ANTIGUO"));
                    s_gem_cliente_codigo_antBE.setFLAG_VIGENCIA(jsonObjectItem.getInt("FLAG_VIGENCIA"));
    ...
    public JSONObject getSincronizar(String newURL) {
        ...
        try {
            ...
            if (jsonObjectRest.getInt("status")!=1) {
                ...
                DataBaseHelper.myDataBase.delete("S_GEM_CLIENTE_CODIGO_ANT", null, null);

                String SQL="INSERT OR REPLACE INTO S_GEM_CLIENTE_CODIGO_ANT(" +
