...
public class Cobranza_Flujo1_Seguimiento_Adapter extends ArrayAdapter<Documentos_Cobra_CabBE> implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        mainHolder.fj_item2.setText(documentos_cobra_cabBE.getRAZON_SOCIAL());
        mainHolder.fj_item3.setText(documentos_cobra_cabBE.getTIPODOC());
        mainHolder.fj_item4.setText(documentos_cobra_cabBE.getNUMERO());
        mainHolder.fj_item5.setText(documentos_cobra_cabBE.getFPAGO());
        mainHolder.fj_item6.setText(documentos_cobra_cabBE.getENTIDAD());
