...
$app->get('/bldocumentos_cobra_cab/:p1/:p2/:p3/:p4', 'bldocumentos_cobra_cab:SelectAll');
...
$app->get('/bldocumentos_cobra_det/:p1/:p2/:p3/:p4', 'bldocumentos_cobra_det:SelectAll');
